...
class KategoriKlik extends StatefulWidget {
  @override
  _KategoriKlikState createState() => _KategoriKlikState();
}

class _KategoriKlikState extends State<KategoriKlik> {
  @override
...
class KategoriKlikView extends StatelessWidget {
  KategoriKlikView({this.img, this.nama, this.harga, this.desc});
  final String img;
  final String nama;
  final String harga;
  final String desc;
